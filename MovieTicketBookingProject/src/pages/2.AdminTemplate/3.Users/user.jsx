...
const User = ({ propUser }) => {
    return (
        <tr
            ...
            <td className="px-6 py-4 text-sm text-gray-900 text-center">{propUser.taiKhoan}</td>
            ...
            <td className="px-6 py-4 text-sm text-gray-700 max-w-[150px] wrap-break-words whitespace-normal">{propUser.matKhau}</td>
            ...
            <td className="px-6 py-4 text-center flex justify-center items-center gap-2">
                <button className="text-indigo-600 hover:text-indigo-900 px-3 py-1 rounded-md bg-gray-100 hover:bg-indigo-50 transition font-medium">Edit</button>
                <button className="text-red-600 hover:text-red-900 px-3 py-1 rounded-md bg-gray-100 hover:bg-red-50 transition font-medium">Delete</button>
            </td>
        </tr>
    )
}
